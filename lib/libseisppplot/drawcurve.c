...
/* DRAWCURVE: $Revision: 1.1 $ ; $Date: 2005/07/31 20:11:49 $	*/
...
/* Variant of above for input data defined as doubles. 
Useful in seispp since data are all stored as doubles */
