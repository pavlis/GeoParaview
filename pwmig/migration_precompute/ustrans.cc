...
dmatrix compute_unit_spherical_transformation(GCLgrid& g, double lat, double lon)
{
	...
	// transformation is in fortran order.  We'll push it to 
	// a temporary dmatrix.  This is not very efficient, but 
	// I'm not expecting this routine to be called millions of
	// times
	dmatrix gu(3,3);
	gu(0,0)=grm[0];
	gu(1,0)=grm[1];
