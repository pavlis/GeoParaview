	...
	common /ellipses/ ellipsnum(24), ellipsname(24), ell_eqrad(24), ell_eccsq(24)
...
c-----Make sure the longitude is between -180.00 .. 179.9
	LongTemp = Long
c	longt = (Long+180)/360
c	LongTemp = (Long+180)-longt*360-180
c----- -180.00 .. 179.9

	LatRad = Lat*deg2rad
	LongRad = LongTemp*deg2rad

	longt = (LongTemp + 180)/6
	ZoneNumber = longt + 1
  
	if(Lat.ge.56.0.and.Lat.lt.64.0.and.LongTemp.ge.3.0.and.LongTemp.lt.12.0) ZoneNumber = 32
...
c-----This is here as an error flag to show that the Latitude is outside the UTM limits
	...
	subroutine utmtoll (ReferenceEllipsoid, UTMNorthing, UTMEasting, UTMZone,
     +             Lat,  Long, ZoneNumber)
